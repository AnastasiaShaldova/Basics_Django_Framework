...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = ShopUser.objects.create_superuser('django', 'django@geekshop.local', 'django')
        self.user = ShopUser.objects.create_user('orduser', 'orduser@geekshop.local', 'orduser')
        self.user_with__first_name = ShopUser.objects.create_user('umaturman', 'umaturman@geekshop.local', 'umaturman',
                                                                  first_name='Умка')
    ...
    def test_user_login(self):
        ...
        # данные пользователя
        self.client.login(username='orduser', password='orduser')
    ...
    def test_basket_login_redirect(self):
        ...
        self.assertIn('Ваши заказы, Пользователь', response.content.decode())
